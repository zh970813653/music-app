    ...
    <div class="playlist" @click="hide" v-show="showFlag">
      <div class="list-wrapper" @click.stop>
        ...
        <scroll ref="listContent" class="list-content">
          ...
          <!-- <ul> -->
            <li ref="current" @click="selectItem(item,index)" class="item" v-for="(item,index) in sequenceList" :key="item.id">
...
export default {
  ...
  methods: {
    ...
    scrollToCurrent (current) {
      ...
      this.$refs.listContent.scrollToElement(this.$refs.current[index], 300)
    },
